  ...
  return (
    <div className="flex  justify-center">
      <div className="flex  pt-4 gap-x-4">
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="px-12 rounded text-xs font-bold text-white py-1 bg-gradient-to-r to-[#025BD4] from-blue-500 hover:from-pink-500 hover:to-yellow-500"
            >
              Back to home
            </button>
          </div>
        ...
        <div style={{ width: "750px" }} className="w-750 bg-white rounded-md">
                ...
                <div className="px-6">
                  ...
                  <div className="flex items-end pt-4 px-4">
                    ...
                    <button
                      ...
                      className="px-4  rounded-full text-sm  font-bold text-white py-1 bg-gradient-to-r to-[#025BD4] from-blue-500 hover:from-pink-500 hover:to-yellow-500"
                    >
                      Continue
                    </button>
                  </div>
