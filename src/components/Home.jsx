        ...
        >
          <div className="flex">
            ...
            <h2 className="text-md pt-1 text-gray-700 font-bold">
              Get Conplete about case from AI driven research assistance
            </h2>
          </div>
          <textarea
            placeholder="Ex: Land Dispute,Mumbai,recnt judgement"
            className="textarea focus:border-sky-500 bg-white textarea-xs m-1 w-full"
          ></textarea>
          ...
          <div className="flex items-end pt-24">
            ...
            <button
              onClick={handleNext}
              className="px-12 rounded-full text-xs font-bold text-white py-1 bg-gradient-to-r to-[#025BD4] from-blue-500 hover:from-pink-500 hover:to-yellow-500"
            >
              Start
            </button>
          </div>
